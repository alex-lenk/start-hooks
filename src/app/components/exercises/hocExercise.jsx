    ...
    return (
        <CollapseWrapper title="Упражнение">
            ...
            <ul>
                ...
                <li>
                    Отображает кнопку &quotВойти&quot, если пользователь НЕ
                    авторизован (зависит от параметра <code>isAuth</code> в{" "}
                    <code>props</code>)
                </li>
                <li>
                    Отображает кнопку с содержанием &quotВыйти из
                    системы&quot, если пользователь авторизован (зависит от
                    параметра <code>isAuth</code> в <code>props</code>)
                </li>
                <li>
                    При нажатии на &quotВойти&quot, вызывается функция{" "}
                    <code>onLogin</code>, а при нажатии на &quotВыйти из
                    системы&quot вызывается <code>onLogOut</code>
                </li>
            </ul>
            <p className="mt-3">
